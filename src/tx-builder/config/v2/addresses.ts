...
export const commonContractAddressBetweenMarketsV2: CommonConfigType = {
  ...
  [Network.mumbai]: {
    ...
    GOVERNANCE_PROTO_CONTRACT: '',
    LEND_TO_AAVE_MIGRATOR: '',
    WETH_GATEWAY: '0x64C5F84debD234E777DA1d4A74245D4303A6966A',
    FAUCET: '',
    SWAP_COLLATERAL_ADAPTER: '',
    REPAY_WITH_COLLATERAL_ADAPTER: '',
    FLASHLIQUIDATION: '',
    INCENTIVES_CONTROLLER: '0xE61D4ed55dE1eB87ddd2F6Ef1b2Ef9d3938dd6c0',
  },
};
...
export const distinctContractAddressBetweenMarketsV2: LendingPoolConfigType = {
  [Market.Proto]: {
    ...
    [Network.mumbai]: {
      LENDINGPOOL_ADDRESS: '0x8d3bd49D44A80D3e77768e42d1dbA3DeA31871f1',
    },
  },
  [Market.AMM]: {
    [Network.kovan]: {
