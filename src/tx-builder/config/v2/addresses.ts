...
export const commonContractAddressBetweenMarketsV2: CommonConfigType = {
  ...
  [Network.mumbai]: {
    ...
    GOVERNANCE_PROTO_CONTRACT: '',
    LEND_TO_AAVE_MIGRATOR: '',
    WETH_GATEWAY: '0x5ebebed54d0696F127C4AE548e2Eb73E8D696E48',
    FAUCET: '',
    SWAP_COLLATERAL_ADAPTER: '',
    REPAY_WITH_COLLATERAL_ADAPTER: '',
    FLASHLIQUIDATION: '',
    INCENTIVES_CONTROLLER: '0xc31c45a46e55f714f9CB2b43Ae688487C16616e2',
  },
};
...
export const distinctContractAddressBetweenMarketsV2: LendingPoolConfigType = {
  [Market.Proto]: {
    ...
    [Network.mumbai]: {
      LENDINGPOOL_ADDRESS: '0xE3a861BC6579CE680aB94927B901A6D242B13296',
    },
  },
  [Market.AMM]: {
    [Network.kovan]: {
