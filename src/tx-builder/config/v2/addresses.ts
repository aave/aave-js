...
export const commonContractAddressBetweenMarketsV2: CommonConfigType = {
  ...
  [Network.mumbai]: {
    ...
    GOVERNANCE_PROTO_CONTRACT: '',
    LEND_TO_AAVE_MIGRATOR: '',
    WETH_GATEWAY: '0xB2068784B0b281Fce0135Cc8E1801102EE86a089',
    FAUCET: '',
    SWAP_COLLATERAL_ADAPTER: '',
    REPAY_WITH_COLLATERAL_ADAPTER: '',
    FLASHLIQUIDATION: '',
    INCENTIVES_CONTROLLER: '0xa20493558dB697369ffB1b4A4Dc6455ee26aEeff',
  },
};
...
export const distinctContractAddressBetweenMarketsV2: LendingPoolConfigType = {
  [Market.Proto]: {
    ...
    [Network.mumbai]: {
      LENDINGPOOL_ADDRESS: '0x434F709104a11e963a60aC740becaf790DF91754',
    },
  },
  [Market.AMM]: {
    [Network.kovan]: {
