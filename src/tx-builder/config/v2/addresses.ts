...
export const commonContractAddressBetweenMarketsV2: CommonConfigType = {
  ...
  [Network.mumbai]: {
    ...
    GOVERNANCE_PROTO_CONTRACT: '',
    LEND_TO_AAVE_MIGRATOR: '',
    WETH_GATEWAY: '0x9Ade93b71B051f11Ce15C62087DbEC86248b798c',
    FAUCET: '',
    SWAP_COLLATERAL_ADAPTER: '',
    REPAY_WITH_COLLATERAL_ADAPTER: '',
    FLASHLIQUIDATION: '',
    INCENTIVES_CONTROLLER: '0x076ea6c1C8b9a698AB051F0539e6C200B1E6F18f',
  },
};
...
export const distinctContractAddressBetweenMarketsV2: LendingPoolConfigType = {
  [Market.Proto]: {
    ...
    [Network.mumbai]: {
      LENDINGPOOL_ADDRESS: '0xb64EFD766e01209F60DE59973E4020c4F0d0908d',
    },
  },
  [Market.AMM]: {
    [Network.kovan]: {
