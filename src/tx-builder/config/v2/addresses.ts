...
export const commonContractAddressBetweenMarketsV2: CommonConfigType = {
  ...
  [Network.mumbai]: {
    ...
    GOVERNANCE_PROTO_CONTRACT: '',
    LEND_TO_AAVE_MIGRATOR: '',
    WETH_GATEWAY: '0x4FF75998F7DD009dDB296622e2875a7c00049243',
    FAUCET: '',
    SWAP_COLLATERAL_ADAPTER: '',
    REPAY_WITH_COLLATERAL_ADAPTER: '',
    FLASHLIQUIDATION: '',
    INCENTIVES_CONTROLLER: '0xCA8f76C244271A857CE76263e60d294EB24186A8',
  },
};
...
export const distinctContractAddressBetweenMarketsV2: LendingPoolConfigType = {
  [Market.Proto]: {
    ...
    [Network.mumbai]: {
      LENDINGPOOL_ADDRESS: '0xD80210C305982391D1BC5c807a36f9a9718f0f15',
    },
  },
  [Market.AMM]: {
    [Network.kovan]: {
