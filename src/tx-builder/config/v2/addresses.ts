...
export const commonContractAddressBetweenMarketsV2: CommonConfigType = {
  ...
  [Network.arbitrum_rinkeby]: {
    ...
    FAUCET: '0x9359141B6Fd46D630820f6B781DF9Ca74c17A72f',
    SWAP_COLLATERAL_ADAPTER: '',
    REPAY_WITH_COLLATERAL_ADAPTER: '',
    FLASHLIQUIDATION: '',
    INCENTIVES_CONTROLLER: '',
  ...
  [Network.fuji]: {
    ...
    GOVERNANCE_PROTO_CONTRACT: '',
    LEND_TO_AAVE_MIGRATOR: '',
    WETH_GATEWAY: '0x4Dc3A7c0Aba87280a3dBdD947cda4D2C55b2c539',
...
export const distinctContractAddressBetweenMarketsV2: LendingPoolConfigType = {
  [Market.Proto]: {
    ...
    [Network.fuji]: {
      LENDINGPOOL_ADDRESS: '0xaFb8283e2B34eD6C2E383337Fd92c3A47D00f2b4',
    },
    [Network.arbitrum_one]: {
      LENDINGPOOL_ADDRESS: '',
    },
